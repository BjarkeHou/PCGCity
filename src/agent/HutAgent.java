...
public class HutAgent extends Agent {
	...
	public HutAgent(Point2i startPos, Map map) {
		...
		BuildingMoveInstruction m1 = new BuildingMoveInstruction(MOVEDIR.TO,1,BUILDINGTYPE.STARTPOSITION);
		Rule r1 = new Rule(0, CONSTRAINT.ALL, m1);
		...
		BuildingMoveInstruction m2 = new BuildingMoveInstruction(MOVEDIR.AWAY,1,BUILDINGTYPE.STARTPOSITION);
		...
		Rule r3 = new Rule(1, CONSTRAINT.ALL, null);
